          ...
          <div className="col-sm-12 padding_all">
            <div className="col-sm-8">
              <div className="footer_main_1">
                <p>© 2024 Love Medicine Band, LLC. All Rights Reserved. <span className="small">(Design by <Link to="http://www.TemplateOnWeb.com" target="_blank">Template On Web</Link>)</span></p>
              </div>
            </div>
